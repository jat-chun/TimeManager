...
public class CalendarView extends ImageView {
	...
	private Drawable mDecoraClick = null;
	...
	public CalendarView(Context context, AttributeSet attrs, int defStyle) {
		...
		setmDecoraClick(context.getResources().getDrawable(R.drawable.typeb_calendar_today));
		initCalendarView();
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if(getmDecoraClick().getBounds()!=null) {
			getmDecoraClick().draw(canvas);
			// 设置这里过后  要想办法
			setmDecoraClick(context.getResources().getDrawable(R.drawable.typeb_calendar_today));
	...
	public void setmDecoraClick(Drawable mDecoraClick) {
		this.mDecoraClick = mDecoraClick;
	}

	private class GrayCell extends Cell {
		public GrayCell(int dayOfMon, Rect rect, float s) {
			super(dayOfMon, rect, s);
			getmPaint().setColor(Color.GRAY);
		}			
	}
